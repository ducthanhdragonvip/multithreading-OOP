...
public class WebCrawlerMultiThreadUseExecutor {
    ...
    public WebCrawlerMultiThreadUseExecutor(Instant start) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        WebCrawlerMultiThreadUseExecutor crawler = new WebCrawlerMultiThreadUseExecutor(start);
